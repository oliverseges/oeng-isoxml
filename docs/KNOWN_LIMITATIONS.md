...
- Active planned-grid exports include CSV, GeoJSON, shapefile ZIP and map PNG. Active executed-channel exports include CSV, GeoJSON, shapefile ZIP and map PNG. Validation and object-registry JSON exports are not implemented.
